...
const LevelScript level_main_scripts_entry[] = {
    ...
    LOAD_MODEL_FROM_GEO(MODEL_MARKER,                  marker_geo),
    LOAD_MODEL_FROM_GEO(MODEL_MARKER2,                 marker2_geo),
    LOAD_MODEL_FROM_GEO(MODEL_MARKER3,                 marker3_geo),
    LOAD_MODEL_FROM_GEO(MODEL_MARKER4,                 marker4_geo),
    LOAD_MODEL_FROM_GEO(MODEL_MARKER5,                 marker5_geo),
    LOAD_MODEL_FROM_GEO(MODEL_MARKER6,                 marker6_geo),
    LOAD_MODEL_FROM_GEO(MODEL_MARKER7,                 marker7_geo),
    LOAD_MODEL_FROM_GEO(MODEL_MARKER8,                 marker8_geo),
    LOAD_MODEL_FROM_GEO(MODEL_MARKER9,                 marker9_geo),
    LOAD_MODEL_FROM_GEO(MODEL_MARKER10,                marker10_geo),
    // LOAD_MODEL_FROM_GEO(MODEL_MARKER11,                marker11_geo),
    // LOAD_MODEL_FROM_GEO(MODEL_MARKER12,                marker12_geo),
    // LOAD_MODEL_FROM_GEO(MODEL_MARKER13,                marker13_geo),
    // LOAD_MODEL_FROM_GEO(MODEL_MARKER14,                marker14_geo),
    // LOAD_MODEL_FROM_GEO(MODEL_MARKER15,                marker15_geo),
    // LOAD_MODEL_FROM_GEO(MODEL_MARKER16,                marker16_geo),
    // LOAD_MODEL_FROM_GEO(MODEL_MARKER17,                marker17_geo),
    // LOAD_MODEL_FROM_GEO(MODEL_MARKER18,                marker18_geo),
    // LOAD_MODEL_FROM_GEO(MODEL_MARKER19,                marker19_geo),
    // LOAD_MODEL_FROM_GEO(MODEL_MARKER20,                marker20_geo),
    ...
    LOAD_MODEL_FROM_GEO(MODEL_BLOCK4,                  block4_geo),
    LOAD_MODEL_FROM_GEO(MODEL_BLOCK5,                  block5_geo),
    LOAD_MODEL_FROM_GEO(MODEL_BLOCK6,                  block6_geo),
    LOAD_MODEL_FROM_GEO(MODEL_BLOCK7,                  block7_geo),
    LOAD_MODEL_FROM_GEO(MODEL_BLOCK8,                  block8_geo),
    LOAD_MODEL_FROM_GEO(MODEL_BLOCK9,                  block9_geo),
    LOAD_MODEL_FROM_GEO(MODEL_BLOCK10,                 block10_geo),
    // LOAD_MODEL_FROM_GEO(MODEL_BLOCK11,                 block11_geo),
    // LOAD_MODEL_FROM_GEO(MODEL_BLOCK12,                 block12_geo),
    // LOAD_MODEL_FROM_GEO(MODEL_BLOCK13,                 block13_geo),
    // LOAD_MODEL_FROM_GEO(MODEL_BLOCK14,                 block14_geo),
    // LOAD_MODEL_FROM_GEO(MODEL_BLOCK15,                 block15_geo),
    // LOAD_MODEL_FROM_GEO(MODEL_BLOCK16,                 block16_geo),
    // LOAD_MODEL_FROM_GEO(MODEL_BLOCK17,                 block17_geo),
    // LOAD_MODEL_FROM_GEO(MODEL_BLOCK18,                 block18_geo),
    // LOAD_MODEL_FROM_GEO(MODEL_BLOCK19,                 block19_geo),
    // LOAD_MODEL_FROM_GEO(MODEL_BLOCK20,                 block20_geo),

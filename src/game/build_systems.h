...
#define MAX_PLACED_BLOCKS_PER_LEVEL 50// 512 is safe
#define MARKER_TYPE_COUNT 32 // preview object models
#define BLOCK_TYPE_COUNT 32 // types of objects to place
